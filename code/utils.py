...
class binarybird_dataset(data.Dataset):
    def __init__(self, main_df, augmentation = None, path=None, effective_sec = 5, aug_per = 0.0, is_validation = False):
    ...
    def __getitem__(self, idx):
        ...
        ids = info["itemid"]        
        waveform, sample_rate = torchaudio.load(f'{self.path}/{ids}.ogg')
